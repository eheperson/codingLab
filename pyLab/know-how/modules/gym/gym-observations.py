...
# In fact, step returns four values. These are: 
#  
#   observation (object): An environment-specific object representing your observation of the environment. 
#                         For example, pixel data from a camera, joint angles and joint velocities of 
#                         a robot, or the board state in a board game. 
#
#   reward (float): Amount of reward achieved by the previous action. 
#                   The scale varies between environments, but the goal 
#                   is always to increase your total reward.
#  
#   done (boolean): Whether it’s time to reset the environment again. 
#                   Most (but not all) tasks are divided up into well-defined episodes, and 
...
# ------------------------------------------------------------------------------------------------------------
#   An implementation of the classic “agent-environment loop”  :
