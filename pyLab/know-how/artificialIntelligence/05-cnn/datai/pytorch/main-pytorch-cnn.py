...
trainNegArr = cnn.readImg(trainNegativeP, trainNegativeN)
#
xTrainNegTensor = torch.from_numpy(trainNegArr) 
print("*\n*")
print("xTrainNegTensor : ", xTrainNegTensor.size())
tTrainNegTensor = torch.zeros(trainNegativeN, dtype=torch.long)
print("xTrainNegTensor : ", tTrainNegTensor.size())
#
# --------------------------------------------------------------------- #
#   Read Train Positive 43390 image
...
trainPosArr = cnn.readImg(trainPositiveP, trainPositiveN)
# 
xTrainPosTensor = torch.from_numpy(trainPosArr)
print("*\n*")
print("xTrainPosTensor : ", xTrainPosTensor.size())
tTrainPosTensor = torch.ones(trainPositiveN, dtype=torch.long)
...
testNegativeN = 22050
testNegArr = cnn.readImg(testNegativeP, testNegativeN)
#
xTestNegTensor = torch.from_numpy(testNegArr[:20855, :])
print("*\n*")
print("xTestNegTensor : ", xTestNegTensor.size())
tTestNegTensor = torch.zeros(20855, dtype=torch.long)
print("tTestNegTensor : ", tTestNegTensor.size())
#
# --------------------------------------------------------------------- #
#   Read Test Positive 43390 image
...
testPositiveN = 5944
testPosArr = cnn.readImg(testPositiveP, testPositiveN)
#
