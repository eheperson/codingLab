...
#configuration of database file location
#app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///tmp/database.db'
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///database.db'

db = SQLAlchemy(app)

#coding model to store videos
...
#       db.create_all()
# Dont forget delete db.create_all() after creating class model
# We don't wanna do that a second time
# (that is gonna overwrite the data in our database)
