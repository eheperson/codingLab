...
# Display an image
def show(img):
    img2 = PIL.Image.fromarray(np.array(img))
    img2.show()
...
show(original_img)
url2 = "https://upload.wikimedia.org/wikipedia/commons/b/b6/Felis_catus-cat_on_snow.jpg"
name2 = url2.split('/')[-1]
image2_path = tf.keras.utils.get_file(name2, origin=url2)
