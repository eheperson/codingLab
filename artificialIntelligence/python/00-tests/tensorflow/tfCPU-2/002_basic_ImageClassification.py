...
# Most layers, such as tf.keras.layers.Dense, 
...
# or fully connected, neural layers. The first Dense layer has 128 nodes (or neurons). 
...
# it needs a few more settings. These are added during the model's compile step:
...
#     3- You ask the model to make predictions about a test set—in 
...
#
#
# keras.Model.predict returns a list of lists—one list for each 
