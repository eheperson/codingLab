...
def tensor(i) :
    """
        External overloaded tensor constructor function :
           tensor(int)              : tensor constructor via 1D dimension input (i)
           tensor(int, int)         : tensor constructor via 2D dimension input (i,j)
           tensor(int, int, int)    : tensor constructor via 3D dimension input (i,j,k)
           tensor(list)             : tensor constructor via data array (for any 2D data matrix)
    """
    tmp = []
    for x in range (i):
        tmp.append(0)
